...
const AddStaff = () => {
  ...
  const handleSubmitt = async (e) => {
    ...
    try {
      if (validateForm()) {
        await axios.post("http://localhost:1234/addStaff", staff).then((res) => {
          setStaff(res.data);
          console.log(staff);
          Swal.fire({
          ...
          <div className="p-4 shadow rounded bg-white md-6">
            ...
            <Form onSubmit={handleSubmitt}>
              ...
              <Form.Group controlId="formcounsellorMobile" className="mb-3">
                <Form.Label className="float-start">counsellorMobile Number</Form.Label>
                <Form.Control
                  type="text"
                  name="counsellorMobile"
                  placeholder="Enter your counsellorMobile number"
                  onChange={onInputchange}
                  className="input-style"
                  pattern="[789][0-9]{9}"
                />
